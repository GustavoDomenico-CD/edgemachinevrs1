document.addEventListener('DOMContentLoaded', function() {
    ...
    const correctAnswers = {
        q1: "true", q2: "B", q3: "B", q4: "B", q5: "true",
        q6: "B", q7: "C", q8: "C", q9: "D", q10: "true",
        q11: "A", q12: "C", q13: "B", q14: "C", q15: "false"
    };
    ...
    function displayResults(score, percentage) {
        ...
        if (percentage >= PASSING_SCORE) {
            ...
            resultActions.innerHTML = `
                <a href="capitulo8.html" class="btn-primary">Próximo Capítulo <i class="fas fa-arrow-right"></i></a>
            ...
            resultActions.innerHTML = `
                <a href="capitulo7.html" class="btn-primary">Revisar Capítulo 7 <i class="fas fa-book"></i></a>
                <button id="retry-quiz" class="btn-outline">Refazer Quiz <i class="fas fa-sync-alt"></i></button>
            `;
        }
