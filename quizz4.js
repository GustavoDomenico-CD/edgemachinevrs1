document.addEventListener('DOMContentLoaded', function() {
    ...
    const correctAnswers = {
        q1: "true", q2: "B", q3: "C", q4: "C", q5: "true",
        q6: "A", q7: "B", q8: "B", q9: "C", q10: "false",
    ...
    function displayResults(score, percentage) {
        ...
        if (percentage >= PASSING_SCORE) {
            ...
            resultActions.innerHTML = `
                <a href="capitulo5.html" class="btn-primary">Próximo Capítulo <i class="fas fa-arrow-right"></i></a>
            ...
            resultActions.innerHTML = `
                <a href="capitulo4.html" class="btn-primary">Revisar Capítulo 4 <i class="fas fa-book"></i></a>
                <button id="retry-quiz" class="btn-outline">Refazer Quiz <i class="fas fa-sync-alt"></i></button>
            `;
        }
