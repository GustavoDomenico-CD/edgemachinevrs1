document.addEventListener('DOMContentLoaded', function() {
    ...
    const TOTAL_QUESTIONS = 15; // Questões com pontuação (a questão 15 é reflexiva)
    ...
    // Respostas corretas para o Quiz 2
    const correctAnswers = {
        q1: "C", q2: "B", q3: "false", q4: "C", q5: "C",
        q6: "false", q7: "C", q8: "B", q10: "C", q11: "true",
        q12: "B", q13: "D", q14: "C", q15: "B"
    };
    ...
    function calculateScore() {
        ...
        for (let i = 1; i <= TOTAL_QUESTIONS; i++) {
            // Pula a questão 9 que é reflexiva e não tem pontuação
            if (i === 9) continue;
    ...
    function displayResults(score, percentage) {
        ...
        if (percentage >= PASSING_SCORE) {
            ...
            resultActions.innerHTML = `
                <a href="capitulo3.html" class="btn-primary">Próximo Capítulo <i class="fas fa-arrow-right"></i></a>
            ...
            resultActions.innerHTML = `
                <a href="capitulo2.html" class="btn-primary">Revisar Capítulo 2 <i class="fas fa-book"></i></a>
                <button id="retry-quiz" class="btn-outline">Refazer Quiz <i class="fas fa-sync-alt"></i></button>
            `;
        }
