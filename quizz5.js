document.addEventListener('DOMContentLoaded', function() {
    ...
    const correctAnswers = {
        q1: "false", q2: "C", q3: "C", q4: "A", q5: "C",
        q6: "true", q7: "D", q8: "B", q9: "C", q10: "true",
        q11: "B", q12: "B", q13: "B", q14: "B", q15: "false"
    };
    ...
    function displayResults(score, percentage) {
        ...
        if (percentage >= PASSING_SCORE) {
            ...
            resultActions.innerHTML = `
                <a href="capitulo6.html" class="btn-primary">Próximo Capítulo <i class="fas fa-arrow-right"></i></a>
            ...
            resultActions.innerHTML = `
                <a href="capitulo5.html" class="btn-primary">Revisar Capítulo 5 <i class="fas fa-book"></i></a>
                <button id="retry-quiz" class="btn-outline">Refazer Quiz <i class="fas fa-sync-alt"></i></button>
            `;
        }
