document.addEventListener('DOMContentLoaded', function() {
    ...
    const TOTAL_QUESTIONS = 15; // Questões com pontuação (excluindo a questão reflexiva)
    ...
    const correctAnswers = {
        q1: "B", q2: "false", q3: "C", q4: "C", q5: "C",
        q6: "true", q7: "C", q8: "B", q9: "true", q10: "B",
        q11: "C", q12: "C", q13: "B", q14: "C", q15: "true"
    };
    ...
    function displayResults(score, percentage) {
        ...
        if (percentage >= PASSING_SCORE) {
            ...
            resultActions.innerHTML = `
                <a href="capitulo4.html" class="btn-primary">Próximo Capítulo <i class="fas fa-arrow-right"></i></a>
            ...
            resultActions.innerHTML = `
                <a href="capitulo3.html" class="btn-primary">Revisar Capítulo 3 <i class="fas fa-book"></i></a>
                <button id="retry-quiz" class="btn-outline">Refazer Quiz <i class="fas fa-sync-alt"></i></button>
            `;
        }
